...
export default function Navbar() {
  ...
  return (
    <>
      <header className="sticky top-0 w-full z-50 bg-slate-900/95 backdrop-blur-md border-b border-white/10 shadow-lg">        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
